...
public class HttpUtil {
	 ...
	 */
	public static LoadControler putMethod(RequestParams params,String url,BaseListener listener){
	 ...
	 */
	public static LoadControler getMethod(RequestParams params,String url,BaseListener listener){
		int actionId = (int) (Math.random()*100);
		url += "?";
	 ...
	 */
	public static LoadControler get(RequestParams params,String url,BaseListener listener){
	 ...
	 */
	public static LoadControler postMethod(final RequestParams params,String url,final BaseListener listener){
	...
	public static LoadControler post(final RequestParams params,final String url,final BaseListener listener){
		if(!LsUtil.isNetworkAvailable(CoreApplication.appContext) || CoreConfig.deBug){
			listener.onError(CoreConfig.deBug?"debug模式禁用了网络加载":"网络未连接");
			return null;
		}
